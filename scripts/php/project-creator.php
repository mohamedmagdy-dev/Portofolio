...
<html lang="en">
  ...
  <body>
    ...
    <!-- End Header  -->
    <form class="article-data" action="save_project.php" method="post" enctype="multipart/form-data">
      <div class="container">
        <input type="text" placeholder="Project Title" maxlength="50" name="title" required>
        <textarea placeholder="Project Content" name="content" required></textarea>
        <textarea placeholder="Short Content" maxlength="100" name="short_content" required></textarea>
        <input placeholder="Project Category" name="category">
        <input type="file" title="Choose Project Image" id="image" name="image" accept="image/*">
